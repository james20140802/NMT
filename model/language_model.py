...
class LanguageModel(tf.keras.Model):
    ...
    def __init__(self, units, hidden_size, kernel_size, dropout_rate):
        ...
        Args:
          ...
          dropout_rate: float, dropout rate inside the model for training.
        """
        ...
        self.lstm = ResidualLSTMNetwork(units, hidden_size, dropout_rate)
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        output = self.dense(tf.concat([x, y]))
